angular.module('myApp')
 .controller("vizCtrl", function($scope, bookService, kartService) {
	var w = window.innerWidth*0.68*0.95;
	   ...
	   var mainNote = svg.append("text")
	    ...
	    .style("fill", "#888888")
	    .text(function(d) {
	    	return "Library catalog with a different look!";
	    });   
	 
	 
	    d3.json("scripts/main_bubble.json", function(error, root) {
	        console.log(error);
	    ...
	    resetBubbles = function () {
	      ...
	      d3.select("#bubbleItemNote").text("Library catalog with a different look!");
